...
<footer class="text-center text-lg-start bg-white text-muted">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <h6 class="text-uppercase fw-bold mb-4">
                        <i class="fas fa-gem me-3 text-grayish"></i>Por que preferirnos
                    </h6>
                    <p>
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                    ...
                    <p>
                        <a href="<?= $proyect['url'] ?>" class="text-reset">Registrarse</a>
                    </p>
                    <p>
                        <a href="<?= $proyect['url'] ?>" class="text-reset">Iniciar Sesion</a>
                    </p>
                </div>
                <!-- Grid column -->
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
        © <?= date('Y') ?> Copyright:
        <a class="text-reset fw-bold" href="https://mdbootstrap.com/">La Madrina</a>
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->